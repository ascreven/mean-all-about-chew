var app = angular.module('allAboutChewApp', ['ngRoute', 'ngResource']).run(function( $rootScope, $http){
...
app.controller('mainController', function($rootScope, $scope, petService){
